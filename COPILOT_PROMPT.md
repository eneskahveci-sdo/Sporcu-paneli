...
**Sorun** ** (henüz NetGSM Api anahtarları bulunmuyor, NetGSM anlaşması yok. NetGSM komple Frontend kısmından kaldırılabilir)**  
...
2. -- Başarılı giriş sonrası, eğer şifre plain text ise hash'le  
...
 END IF;  
   
3. Bu, mevcut kullanıcıların bir sonraki girişlerinde şifrelerinin otomatik hash'lenmesini sağlar.  
4. Yeni sporcu/antrenör eklerken şifreyi her zaman hash'lenmiş olarak kaydet.  
