    ...
    mappers: {
        ...
        fromAthlete(a) {
            ...
            return {
                ...
                fn: str(a.fn), ln: str(a.ln), tc: str(a.tc),
                bd: str(a.bd) || null, gn: str(a.gn) || 'E',
                ph: str(a.ph), em: str(a.em), sp: str(a.sp),
                cat: str(a.cat), lic: str(a.lic),
                rd: str(a.rd) || new Date().toISOString().slice(0,10),
                st: str(a.st) || 'active',
                fee: num(a.fee), vd: str(a.vd) || null,
                nt: str(a.nt), cls_id: str(a.clsId) || null,
                pn: str(a.pn), pph: str(a.pph), pem: str(a.pem),
                sp_pass: str(a.spPass),
                address: str(a.address), city: str(a.city),
                emergency: str(a.emergency), blood: str(a.blood),
                height: num(a.height) || null, weight: num(a.weight) || null,
                health: str(a.health), school: str(a.school)
            };
        },
        toPayment(r) {
            return {
