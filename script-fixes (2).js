// ═══════════════════════════════════════════════════════════
// HATA DÜZELTMELERİ V4 — Bu dosya script.js'den SONRA yüklenir
//
// ÖNEMLİ: loadOnKayitlar global "function declaration" olarak
// yeniden tanımlanıyor ki loadBranchData içindeki çağrı da
// bu versiyonu kullansın (hoisting sebebiyle script.js'deki
// function declaration'ı ezer — aynı scope'ta olduğu için).
// ═══════════════════════════════════════════════════════════

// ────────────────────────────────────────────────────────
// 1) KVKK ve KULLANIM ŞARTLARI
// ────────────────────────────────────────────────────────
window.showLegal = function(type) {
    var c = {
        kvkk: {
            title: 'KVKK Ayd\u0131nlatma Metni',
            body: '<div class="legal-content">'
                + '<h2>Dragos Futbol Akademisi \u2013 Ki\u015Fisel Verilerin Korunmas\u0131 ve \u0130\u015Flenmesi Hakk\u0131nda Ayd\u0131nlatma Metni</h2>'
                + '<p>Dragos Futbol Akademisi olarak, ki\u015Fisel verilerinizin g\u00FCvenli\u011Fi ve gizlili\u011Fi bizim i\u00E7in \u00F6nemlidir. Bu ayd\u0131nlatma metni, taraf\u0131m\u0131za iletilen ki\u015Fisel verilerin hangi ama\u00E7larla i\u015Flendi\u011Fi ve korunmas\u0131na ili\u015Fkin usul ve esaslar\u0131 a\u00E7\u0131klamak amac\u0131yla haz\u0131rlanm\u0131\u015Ft\u0131r.</p>'
                + '<h3>1. Veri Sorumlusu</h3>'
                + '<p>6698 say\u0131l\u0131 Ki\u015Fisel Verilerin Korunmas\u0131 Kanunu (\u201CKVKK\u201D) kapsam\u0131nda veri sorumlusu Dragos Futbol Akademisi\u2019dir.</p>'
                + '<h3>2. \u0130\u015Flenen Ki\u015Fisel Veriler</h3>'
                + '<p>Web sitemiz, kay\u0131t formlar\u0131 veya ileti\u015Fim kanallar\u0131 arac\u0131l\u0131\u011F\u0131yla a\u015Fa\u011F\u0131daki ki\u015Fisel veriler i\u015Flenebilir:</p>'
                + '<ul><li>Ad ve soyad</li><li>Telefon numaras\u0131</li><li>E-posta adresi</li><li>Veli bilgileri</li><li>Sporcu bilgileri</li><li>Do\u011Fum tarihi</li><li>\u0130leti\u015Fim mesajlar\u0131</li><li>IP adresi ve site kullan\u0131m bilgileri</li></ul>'
                + '<h3>3. Ki\u015Fisel Verilerin \u0130\u015Flenme Ama\u00E7lar\u0131</h3>'
                + '<p>Toplanan ki\u015Fisel veriler a\u015Fa\u011F\u0131daki ama\u00E7larla i\u015Flenebilir:</p>'
                + '<ul><li>Futbol okulu kay\u0131t i\u015Flemlerinin ger\u00E7ekle\u015Ftirilmesi</li><li>Sporcu ve veli ileti\u015Fiminin sa\u011Flanmas\u0131</li><li>Antrenman, etkinlik ve organizasyon bilgilendirmeleri</li><li>Hizmet kalitesinin art\u0131r\u0131lmas\u0131</li><li>Yasal y\u00FCk\u00FCml\u00FCl\u00FCklerin yerine getirilmesi</li><li>Web sitesi kullan\u0131m\u0131n\u0131n geli\u015Ftirilmesi</li></ul>'
                + '<h3>4. Verilerin Aktar\u0131lmas\u0131</h3>'
                + '<p>Ki\u015Fisel verileriniz;</p>'
                + '<ul><li>Yasal y\u00FCk\u00FCml\u00FCl\u00FCkler kapsam\u0131nda yetkili kamu kurumlar\u0131na</li><li>Teknik altyap\u0131 sa\u011Flay\u0131c\u0131lar\u0131na</li><li>Hukuki zorunluluk bulunan durumlarda ilgili kurumlara</li></ul>'
                + '<p>aktar\u0131labilir.</p>'
                + '<h3>5. Verilerin Saklanma S\u00FCresi</h3>'
                + '<p>Ki\u015Fisel veriler, i\u015Flenme amac\u0131 ortadan kalkana kadar veya yasal saklama s\u00FCresi boyunca muhafaza edilir.</p>'
                + '<h3>6. KVKK Kapsam\u0131ndaki Haklar\u0131n\u0131z</h3>'
                + '<p>KVKK\u2019n\u0131n 11. maddesi kapsam\u0131nda a\u015Fa\u011F\u0131daki haklara sahipsiniz:</p>'
                + '<ul><li>Ki\u015Fisel verilerinizin i\u015Flenip i\u015Flenmedi\u011Fini \u00F6\u011Frenme</li><li>\u0130\u015Flenmi\u015Fse bilgi talep etme</li><li>Amac\u0131na uygun kullan\u0131l\u0131p kullan\u0131lmad\u0131\u011F\u0131n\u0131 \u00F6\u011Frenme</li><li>Eksik veya yanl\u0131\u015F i\u015Flenmi\u015Fse d\u00FCzeltilmesini isteme</li><li>Kanuna uygun olarak silinmesini veya yok edilmesini talep etme</li></ul>'
                + '<p>Bu haklar\u0131n\u0131z\u0131 kullanmak i\u00E7in web sitemizde yer alan ileti\u015Fim bilgileri \u00FCzerinden Dragos Futbol Akademisi ile ileti\u015Fime ge\u00E7ebilirsiniz.</p>'
                + '</div>'
        },
        kullanim: {
            ...
            body: '<div class="legal-content">'
                ...
                + '<p>Bu web sitesini ziyaret eden t\u00FCm kullan\u0131c\u0131lar a\u015Fa\u011F\u0131daki kullan\u0131m \u015Fartlar\u0131n\u0131 kabul etmi\u015F say\u0131l\u0131r.</p>'
                + '<h3>1. Genel H\u00FCk\u00FCmler</h3>'
                + '<p>Dragos Futbol Akademisi web sitesi, futbol e\u011Fitimi faaliyetleri hakk\u0131nda bilgilendirme yapmak amac\u0131yla haz\u0131rlanm\u0131\u015Ft\u0131r.</p>'
                + '<h3>2. \u0130\u00E7erik Kullan\u0131m\u0131</h3>'
                + '<p>Web sitesinde yer alan:</p>'
                + '<ul><li>Metinler</li><li>G\u00F6rseller</li><li>Logolar</li><li>Videolar</li><li>Tasar\u0131mlar</li></ul>'
                + '<p>Dragos Futbol Akademisi\u2019ne aittir ve izinsiz kopyalanamaz, \u00E7o\u011Falt\u0131lamaz veya ticari ama\u00E7la kullan\u0131lamaz.</p>'
                + '<h3>3. Kullan\u0131c\u0131 Sorumluluklar\u0131</h3>'
                + '<p>Kullan\u0131c\u0131lar web sitesini kullan\u0131rken:</p>'
                + '<ul><li>Yasalara uygun davranmay\u0131</li><li>Yan\u0131lt\u0131c\u0131 veya zarar verici i\u015Flem yapmamay\u0131</li><li>Site altyap\u0131s\u0131na zarar vermemeyi</li></ul>'
                + '<p>kabul eder.</p>'
                + '<h3>4. Bilgilendirme \u0130\u00E7eri\u011Fi</h3>'
                + '<p>Web sitesinde yer alan bilgiler bilgilendirme ama\u00E7l\u0131d\u0131r. Dragos Futbol Akademisi gerekli g\u00F6rd\u00FC\u011F\u00FC durumlarda i\u00E7erikleri de\u011Fi\u015Ftirme hakk\u0131n\u0131 sakl\u0131 tutar.</p>'
                + '<h3>5. D\u0131\u015F Ba\u011Flant\u0131lar</h3>'
                + '<p>Web sitesi \u00FC\u00E7\u00FCnc\u00FC taraf sitelere ba\u011Flant\u0131lar i\u00E7erebilir. Bu sitelerin i\u00E7eriklerinden Dragos Futbol Akademisi sorumlu de\u011Fildir.</p>'
                + '<h3>6. De\u011Fi\u015Fiklik Hakk\u0131</h3>'
                + '<p>Dragos Futbol Akademisi, kullan\u0131m \u015Fartlar\u0131n\u0131 \u00F6nceden bildirim yapmaks\u0131z\u0131n de\u011Fi\u015Ftirme hakk\u0131na sahiptir.</p>'
                + '<h3>7. Y\u00FCr\u00FCrl\u00FCk</h3>'
                + '<p>Bu kullan\u0131m \u015Fartlar\u0131 web sitesine eri\u015Fim sa\u011Fland\u0131\u011F\u0131 anda y\u00FCr\u00FCrl\u00FC\u011Fe girer.</p>'
                + '</div>'
        }
    };
    var info = c[type];
    if (info) modal(info.title, info.body, [{ lbl: AppState.lang === 'TR' ? 'Kapat' : 'Close', cls: 'bs', fn: closeModal }]);
};


// ────────────────────────────────────────────────────────
// 2) loadOnKayitlar — GLOBAL FUNCTION DECLARATION
//    script.js'deki "async function loadOnKayitlar" ile
//    aynı scope'ta yeniden tanımlanıyor → otomatik ezer.
//    loadBranchData da artık BU versiyonu çağırır.
// ────────────────────────────────────────────────────────
async function loadOnKayitlar() {
    try {
        ...
        if (!bid && !oid) { console.warn('loadOnKayitlar: org/branch yok'); return; }
        ...
        if (data) {
            ...
            console.log('loadOnKayitlar: ' + data.length + ' kayit yuklendi');
...
// ────────────────────────────────────────────────────────
// 3) go() MONKEY-PATCH — sadece athletes sayfası için
//    özel render; diğer sayfalar orijinal go()'ya devredilir
// ────────────────────────────────────────────────────────
...
window.go = function(page, params) {
    ...
    document.querySelectorAll('.ni').forEach(function(el) {
        el.classList.toggle('on', el.id === 'ni-athletes');
    });
    document.querySelectorAll('.bni-btn').forEach(function(el) {
        el.classList.toggle('on', el.id === 'bn-athletes');
    });
    closeSide();
};
    ...
    if (isAdmin || isCoach) {
        ...
        if (onKayitlar.length === 0) {
            ...
            onKayitlar.forEach(function(ok) {
                ...
                var badge = ok.status === 'new' ? '<span class="bg bg-y">\u23F3 Bekliyor</span>' : '<span class="bg bg-g">\u2705 \u0130\u015Flendi</span>';
                var btns = '';
...
// ────────────────────────────────────────────────────────
// 5) convertOnKayit — sporcu formunu prefill ile aç
// ────────────────────────────────────────────────────────
window.convertOnKayit = function(id) {
    ...
    editAth(null, {
        fn: ok.fn || '', ln: ok.ln || '', tc: ok.tc || '', bd: ok.bd || '',
        pn: ok.parentName || '', pph: ok.parentPhone || '',
        clsId: cls ? cls.id : (ok.clsId || ''), sp: ''
    });
...
// ────────────────────────────────────────────────────────
// 6) showOnKayitForm — ön kayıt formu (giriş yapmamış
//    kullanıcılar için de org/branch'i otomatik bulur)
// ────────────────────────────────────────────────────────
window.showOnKayitForm = async function() {
    ...
    // Sınıfları ve org/branch bilgisini çek
    if (classes.length === 0) {
...
window.submitOnKayit = async function() {
    ...
    try {
        ...
        if (sb) {
            ...
            if (res.error) { console.error('on_kayitlar insert error:', res.error); toast('Hata: ' + (res.error.message || ''), 'e'); }
            else ok = true;
        }
    ...
    toast(ok ? '\u2705 \u00D6n kay\u0131t ba\u015Far\u0131yla al\u0131nd\u0131!' : '\u26A0\uFE0F Sunucuya g\u00F6nderilemedi.', ok ? 'g' : 'e');
};


// ────────────────────────────────────────────────────────
// 8) ÖN KAYIT BUTONU — Yönetici modunda gizle
// ────────────────────────────────────────────────────────
...
// URL'de admin varsa butonu gizle
setTimeout(function() {
...
console.log('\u2705 Script-fixes V4 yuklendi');
