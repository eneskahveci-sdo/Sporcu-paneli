...
-- NOT: Gercek uygulamada daha kisitli politikalar kullanilmali!

-- Athletes tablosu
CREATE POLICY "Allow read athletes" ON athletes FOR SELECT USING (true);
CREATE POLICY "Allow insert athletes" ON athletes FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow update athletes" ON athletes FOR UPDATE USING (true);
CREATE POLICY "Allow delete athletes" ON athletes FOR DELETE USING (true);
...
CREATE POLICY "Allow update payments" ON payments FOR UPDATE USING (true);
CREATE POLICY "Allow delete payments" ON payments FOR DELETE USING (true);

-- Coaches tablosu
CREATE POLICY "Allow read coaches" ON coaches FOR SELECT USING (true);
CREATE POLICY "Allow insert coaches" ON coaches FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow update coaches" ON coaches FOR UPDATE USING (true);
CREATE POLICY "Allow delete coaches" ON coaches FOR DELETE USING (true);
...
CREATE POLICY "Allow delete attendance" ON attendance FOR DELETE USING (true);
...
-- Sports tablosu
CREATE POLICY "Allow read sports" ON sports FOR SELECT USING (true);
CREATE POLICY "Allow insert sports" ON sports FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow update sports" ON sports FOR UPDATE USING (true);
CREATE POLICY "Allow delete sports" ON sports FOR DELETE USING (true);

-- Classes tablosu
CREATE POLICY "Allow read classes" ON classes FOR SELECT USING (true);
CREATE POLICY "Allow insert classes" ON classes FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow update classes" ON classes FOR UPDATE USING (true);
CREATE POLICY "Allow delete classes" ON classes FOR DELETE USING (true);
...
CREATE POLICY "Allow update branches" ON branches FOR UPDATE USING (true);

-- Orgs tablosu
CREATE POLICY "Allow read orgs" ON orgs FOR SELECT USING (true);
CREATE POLICY "Allow insert orgs" ON orgs FOR INSERT WITH CHECK (true);
